...
import {
    ...
    Store, FileText, Send, AlertCircle, ChevronLeft, UtensilsCrossed, Layers
} from "lucide-react"
        ...
        <div className="max-w-3xl mx-auto space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground text-sm">Retirer des ingrédients du stock de transition pour le chef cuisinier</p>
                </div>
            </div>
            ...
            <form onSubmit={(e) => { e.preventDefault(); handleSubmit() }} className="space-y-6">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Retirer du stock de transition pour donner au chef cuisinier</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <div className="space-y-1.5">
                            <Label className="text-sm font-medium flex items-center gap-1.5">
                                <Store className="h-4 w-4 text-muted-foreground" /> Depuis (Stock Transition)
                            </Label>
                ...
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between">
                        <div>
                            ...
                            <CardDescription>Sélectionnez les ingrédients à remettre au chef cuisinier</CardDescription>
                        </div>
